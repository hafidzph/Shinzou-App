 ...
 * Use the [FragmentBiodataPenumpang.newInstance] factory method to
...
class FragmentBiodataPenumpang : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentBiodataPenumpang.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentBiodataPenumpang().apply {
