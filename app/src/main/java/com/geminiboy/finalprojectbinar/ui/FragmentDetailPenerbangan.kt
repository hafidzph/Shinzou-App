 ...
 * Use the [FragmentDetailPenerbangan.newInstance] factory method to
...
class FragmentDetailPenerbangan : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentDetailPenerbangan.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentDetailPenerbangan().apply {
