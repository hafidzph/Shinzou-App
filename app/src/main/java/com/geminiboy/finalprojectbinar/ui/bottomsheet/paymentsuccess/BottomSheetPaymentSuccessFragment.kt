 ...
 * Use the [BottomSheetPaymentSuccessFragment.newInstance] factory method to
...
class BottomSheetPaymentSuccessFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment BottomSheetPaymentSuccessFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BottomSheetPaymentSuccessFragment().apply {
